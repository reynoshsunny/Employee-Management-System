...
namespace EMS
{
    public partial class DailyOffice : Form
    {
        public DailyOffice()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO WORKDET VALUES ( " + Global._userid + " , '" + WorkDate.ToString("yyyy-MM-dd") + "' , '" + WorkName + "' , '" + WorkDescription + "' , '" + WorkTime + "' , 'OFFICE', '" + DateTime.Now + "' , '" + item + "') ";

            SqlCommand cmd = new SqlCommand(query, er);
            cmd.ExecuteNonQuery();

            MessageBox.Show("Office work added successfully !");
        ...
        private void DailyOffice_Load(object sender, EventArgs e)
        {
