...
namespace EMS
{
    public partial class DailyDigital : Form
    {
        public DailyDigital()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO WORKDET VALUES ( " + Global._userid + " , '" + WorkDate.ToString("yyyy-MM-dd") + "' , '" + WorkName + "' , '" + WorkDescription + "' , '" + WorkTime + "' , 'DIGITAL MARKETING', '" + DateTime.Now + "' , '"+  item  + "') ";

            SqlCommand cmd = new SqlCommand(query, er);
            cmd.ExecuteNonQuery();

            MessageBox.Show("Digital marketing work added successfully !");
        ...
        private void DailyDigital_Load(object sender, EventArgs e)
        {
